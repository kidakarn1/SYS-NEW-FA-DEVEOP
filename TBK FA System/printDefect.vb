...
outloop:
        ...
        Dim rsInserttagdefect = md.mInserttagdefect(lwi, lLine, lPartno, lItemtype, lLot, lSeq, sDefect, CDbl(Val(lQtydefect)), TypeMenu, "001", qrDefectinfo, qrDefectcodedetails, lItemtype, date_now, lLine, date_now, lLine)
    End Sub
End Class