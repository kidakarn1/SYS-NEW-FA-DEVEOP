...
Public Class print_back
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        Backoffice_model.Insert_tag_print_main(Working_Pro.wi_no.Text, qr_code, the_Label_bach, 1, plan_seq, Working_Pro.Label14.Text, check_tagprint_main(), Working_Pro.Label3.Text)
    ...
    Private Sub PrintDocument2_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument2.PrintPage
        ...
        e.Graphics.DrawString("Phase10", lb_font3.Font, Brushes.Black, 33, 250)
        e.Graphics.DrawImage(bitmap_qr_box, 600, 205, 75, 75) 'Right top
        Backoffice_model.Insert_tag_print(Working_Pro.wi_no.Text, qr_code, box_no, 1, plan_seq, Working_Pro.Label14.Text, Working_Pro.check_tagprint(), Working_Pro.Label3.Text)
    End Sub
End Class
