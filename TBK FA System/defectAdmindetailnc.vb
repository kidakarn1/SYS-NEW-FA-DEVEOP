...
Public Class defectAdmindetailnc
    Shared sLinecd = ""
    ...
    Public Shared Apwi_id As String = 0
    ...
    Public Sub getDatadefect(sLinecd As String, sDate As String, eDate As String)
        ...
        Dim rs = md.mGetDefectadmindetailncFG(sLinecd, sDate, eDate)
        If rs <> "0" Then
            ...
            For Each item As Object In dcResultdata
                ...
                '  datlvDefectsumary.SubItems.Add(item("ITEM_CD").ToString())
    ...
    Private Sub btnOk_Click(sender As Object, e As EventArgs) Handles btnOk.Click
        For Each lvItem As ListViewItem In lvDefectact.SelectedItems
            ...
            ' sNc = lvDefectact.Items(lvItem.Index).SubItems(7).Text
            sNc = lvDefectact.Items(lvItem.Index).SubItems(8).Text
            Apwi_id = lvDefectact.Items(lvItem.Index).SubItems(9).Text
            sNg = 0
        Next
        Dim dfAdminselecttype As New defectAdminselecttypenc()
